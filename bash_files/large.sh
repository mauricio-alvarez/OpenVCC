...
#----------------------------------------------------------------#
#SBATCH -J vcc_large     # Final job name
#SBATCH -p gpu
#SBATCH -c 4
#SBATCH --mem=64G
#SBATCH --gres=gpu:1
#SBATCH -o vcc_output_large_%j.log
#SBATCH -e vcc_error_large_%j.log
...
echo "Starting the VCC experiment for large with manual loading..."

python run_vcc.py \
    --working_dir "outputs/vit_large_sports_car" \
    --target_class "sports_car" \
    --model_to_run "large_vit" \
    --feature_names 5 11 17 23 \
